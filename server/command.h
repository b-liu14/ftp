...
extern void handle_CWD	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_CDUP	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_DELE	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_LIST	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_MKD	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_PWD	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_RMD	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_RNFR	(UserInfo* ptr_user_info, char* param, int socketfd);
extern void handle_RNTO	(UserInfo* ptr_user_info, char* param, int socketfd);